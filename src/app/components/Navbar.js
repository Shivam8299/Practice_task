    ...
    <nav className="w-full">
      ...
      <div className="flex justify-between items-center mx-4 mb-8 md:mx-8 lg:mx-10 my-4">
        ...
        <div className="hidden sm:block">
          <button className="relative flex items-center justify-between px-6 py-2 rounded-full text-white shadow-lg bg-gradient-to-r from-teal-500 to-emerald-600 hover:from-teal-600 hover:to-emerald-700 transition">
            <span>Let's Talk</span>
