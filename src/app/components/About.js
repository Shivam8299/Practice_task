...
function About() {
  return (
    <div>
      <div className=" max-w-[1600px] m-auto gap-4 md:gap-6 lg:gap-8 flex flex-col lg:flex-row items-center justify-center lg:justify-between px-2 sm:px-4 md:px-12 lg:px-20  lg:py-12">
        {/* Image Section */}
        <div className="relative w-full md:w-md lg:w-[50%] flex justify-center px-3">
          {/* Main Image */}
          <img
        ...
        <motion.div
          className="w-full lg:w-1/2 px-2 md:px-4 lg:px-0  text-center md:text-left"
          initial={{ opacity: 0, x: -100 }} // start left
          whileInView={{ opacity: 1, x: 0 }} // animate to normal position
          transition={{ duration: 1, ease: "easeOut" }}
          viewport={{ once: true, amount: 0.2 }} // trigger once, when 20% visible
        >
          <p className="text-xl text-teal-400 text-center lg:text-start">
            ABOUT US
          </p>
          ...
          <div className="flex gap-2 items-center justify-center lg:justify-start mb-4 mt-4">
            <span className=" hidden lg:flex  items-center justify-center w-7 h-7 rounded-full text-white bg-teal-400 text-2xl ">
          ...
          <div className="flex gap-2 items-center justify-center lg:justify-start mb-4">
            <span className="hidden lg:flex items-center justify-center w-7 h-7 rounded-full bg-teal-400  text-2xl text-white">
              <FiChevronRight size={25} />
            </span>
          ...
          <div className="flex gap-2 items-center justify-center lg:justify-start mb-8">
            <span className=" hidden lg:flex justify-center items-center w-7 h-7 rounded-full bg-teal-400  text-2xl text-white">
              <FiChevronRight size={25} />
            </span>
            <p className="text-base font-medium text-gray-600 lg:text-black">
              Quis autem vel eum iure reprehenderit aui
