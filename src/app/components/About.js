  ...
  return (
    <div>
      <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between px-6 md:px-12 lg:px-20 gap-16 py-12">
        {/* Image Section */}
        <div className="relative w-full md:max-w-md lg:w-1/2 flex justify-center">
          {/* Main Image */}
          <img
          ...
          {/* Overlay Image */}
          <img
            className="absolute -left-8 -bottom-8 w-32  rounded-2xl shadow-xl"
        ...
        <motion.div
          className="mt-16 md:mt-0 w-full lg:w-1/2 px-2 md:px-6 lg:px-0 xl:px-6 text-center md:text-left"
